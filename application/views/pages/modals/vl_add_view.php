            ...
            <?= form_open_multipart('vl/add' , ['id' => 'fromAddVisitorLogModal', 'role' => 'form' ]); ?>
                   ...
                   <div class = "form-group row">
                        <div class="col-md-12 mb-12">
                            ...
                            <select class="multiselect-ui form-control" id="inputPart" name="inputPart[]" multiple="multiple">
                                <option value=""> -- Please Choose --</option>
                                <?php foreach($employee as $emp): ?>
                                <option value="<?= $emp->EMP_CODE; ?>"><?= $emp->EMP_FULLNAME; ?></option>
                                <?php endforeach; ?>
                    ...
                    <div class = "form-group row">
                        ...
                        <label for="inputPurposeVisit">Purpose of Visit</label>
                            <textarea class="form-control" id="inputPurposeVisit" placeholder="Enter purpose of visit" name = "inputPurposeVisit" ></textarea>
                        </div>
                    </div>
                   ...
                   <div class = "form-group row">
                        <div class="col-md-12 mb-12">
                            ...
                            <select class="multiselect-ui form-control" id="controlSelectStatusQ1" name="controlSelectStatusQ1[]" multiple="multiple">
                                <option value=""> -- Please Choose --</option>
