                   ...
                   <div class = "form-group row" >
                        <div class="col-md-12 mb-12">
                            ...
                            <select class="multiselect-ui form-control" id="EditinputPart" name="EditinputPart[]" multiple="multiple">
                                ...
                                <?php foreach($participants as $emp): ?>
                                    <?php  if($emp->EMP_CODE == $emp->EMP_CODE){ $text="selected"; } else{ $text=''; } ?> 
                                    <option value="<?= $emp->EMP_CODE; ?>" <?= $text ?> ><?= $emp->EMP_FULLNAME; ?></option>
                                <?php endforeach; ?>
                            </select>   
                        </div>
                    ...
                    <div class = "form-group row">
                        ...
                        <label for="EditinputPurposeVisit">Purpose of Visit</label>
                            <textarea class="form-control" id="EditinputPurposeVisit" placeholder="Enter purpose of visit" name = "EditinputPurposeVisit" readonly><?= $visitor->VISIT_PURP; ?></textarea>
                        </div>
                    </div>
