...
.bs-example{
        ...
        <div class="container box p-3 border mb-5">
          ...
          <!--   <div class="toast" id="myToast"  style="position: absolute; top: 20px; right: 50px;" data-delay="1000">
            ...
            <!-- start visitor table checkin checkout section -->
                <div class="container box p-3 border mb-5">
                    <h4><i class="fa fa-check-square" aria-hidden="true"></i> Visitor Checkin/Checkout</h4>
                    <hr>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    Record was successfully save. Thank you!
                </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            /* For Edit Date range on the date end and start sickness */
            ...
            /*End Edit Date range on the date end and start sickness */
            ...
            $('#inputPart').change(function(e){
             /*    var before_change_code = $(this).data('pre');//get the pre data
                ...
                if($("#inputHost option:selected" ).text() === $( "#inputPart option:selected" ).text()){
            ...
            $('#inputHost').change(function(e){
                if($("#inputPart option:selected" ).text() === $( "#inputHost option:selected" ).text()){
                    alert('Participant Employee cannot be host employee please select other employee.');
