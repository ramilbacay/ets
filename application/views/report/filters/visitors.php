...
<div class="row">
    <div class="col-4 col-sm-4 col-md-4 col-lg-4">
        <div class="custom-control custom-radio">
            <input type="radio" id="VisitorStatus" name="visitor_status" class="custom-control-input" value="3">
            <label class="custom-control-label" for="VisitorStatus">On Going</label>
        </div>                        
    </div>
    <div class="col-4 col-sm-4 col-md-4 col-lg-4">
        <div class="custom-control custom-radio">
            <input type="radio" id="VisitorStatus1" name="visitor_status" class="custom-control-input" value="5">
